...
<p align="center"><b>Proiectul Horizon</b></p>
<p align="center"><b>Un joc indie 2D construit cu Godot</b></p><br>
<p align="center">
  ...
  <img align="center" alt="Platforms" src="https://img.shields.io/badge/Platforme-windows%20%20%7C%20%20linux-lightgrey?style=for-the-badge">
</p>

<h2 align="left">Descărcări</h2>
<p align="left">
  • <a href="link" target="_blank">Ultima versiune lansată</a><br>
...
<br>
<h2 align="left">Despre joc</h2>
Proiectul Horizon este un joc de platformă indie 2D construit folosind motorul Godot.
A fost creat inițial pentru un proiect școlar la <a href="https://www.efrei.fr/" target="_blank">EFREI Paris</a>.
Bucurați-vă de joc! 😄
...
<p align="center">
  ...
  <a href="link to website" target="_blank">Site web</a> | 📖
  <a href="link to wiki" target="_blank">Manual de instrucțiuni</a>
</p>

<br>
<h2 align="left">💽 Instalare</h2>
...
<p align="left">
  Se recomandă instalarea Proiectului Horizon utilizând pachetul de instalare
  (Horizon-Setup-X.Y.Z.exe).
  Cu toate acestea, puteți descărca la fel de bine folderul .zip cu fișierele jocului.
</p>
<br>
Dacă decideți să instalați jocul cu fișierul setup.exe, pur și simplu executați-l și urmați instrucțiunile date.
<br>

Dacă alegeți să rulați jocul cu fișierele de joc nezipe, mergeți la fișierul dvs. nezipe și rulați comenzile următoare de la `linia de comandă` sau din `PowerShell`:

```bash
# Instalați bibliotecile necesare:
Aceasta este comanda de instalare

# Rulați jocul
Aceasta este comanda de rulare
```
...
<h2 align="left">🕹 Utilizare</h2>
Utilizați tastele wasd pentru a vă deplasa pe pânză:<br>
• <kbd>w</kbd> deplasare în sus<br>
• <kbd>a</kbd> deplasare în stânga<br>
• <kbd>s</kbd> deplasare în jos<br>
• <kbd>d</kbd> deplasare în dreapta<br>
și tasta <kbd><b>spațiu</b></kbd> pentru a sări și <kbd><b>f</b></kbd> pentru a ataca sau interacționa.

<br><br>

<h2 align="left">📜 Licență</h2>
Acest program a fost scris în conformitate cu următoarea <a href="https://github.com/Dragan-Constantin/Transverse-S2-Project/blob/main/LICENSE" target="_blank">licență</a>.

<br>
<h2 align="left">Credite</h2>
<p align="left">
  • Dragan Constantin:
